    ...
    <main className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute top-4 flex items-center gap-4 right-4 z-50">
        ...
        <UserButton
          ...
          appearance={{
            elements: {
              avatarBox: "h-10 w-10 rounded-lg transition-all duration-300 hover:scale-105 ring-2 ring-white/20 hover:ring-white/40",
            },
          }}
        />
      </div>
        ...
        <header className="flex flex-col items-center gap-6 animate-fade-in">
          ...
          <div className="flex flex-col items-center gap-6">
            <p className="text-base sm:text-lg text-center text-gray-400 max-w-[600px] leading-relaxed animate-fade-in-up">
              EVO is my attempt to create a general purpose AI agent, that can be used for a wide range of tasks.
            </p>
        ...
        <div className="flex flex-col items-center gap-4">
          <SignedIn>
            <div className="flex items-center gap-4">
              <Link href="/dashboard">
              <button className="group relative px-6 py-4 text-base font-medium text-gray-900 bg-gradient-to-r from-white via-gray-100 to-white rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-[0_0_2rem_-0.5rem_#ffffff]">
                  Chat with EVO
              ...
              <Link href="/docs">
                <button className="group relative px-6 py-4 text-base font-medium text-white border border-white/10 hover:border-white/20 rounded-lg transition-all duration-300 hover:scale-105 backdrop-blur-sm">
                  Learn More
                  <ArrowUpRight className="inline-block ml-2 h-5 w-5 transition-transform group-hover:translate-x-1 group-hover:-translate-y-1" />
                </button>
              </Link>
            </div>
          </SignedIn>
